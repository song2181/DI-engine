...
class CoordinateRegression(Dataset):
    ...
    def __getitem__(self, index: int) -> Tuple[torch.Tensor, torch.Tensor]:
        ...
        image[uv[0] - self.pixel_size // 2:uv[0] + self.pixel_size // 2 + 1,
              uv[1] - self.pixel_size // 2:uv[1] + self.pixel_size // 2 + 1, ] = self.pixel_color
    ...
    def statistics(self) -> dict:
        return DatasetStatistics(action_bounds=self.get_target_bounds)
