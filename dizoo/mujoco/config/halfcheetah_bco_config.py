...
halfcheetah_bco_config = dict(
    ...
    policy=dict(
        ...
        learn=dict(
            train_epoch=20,  # If train_epoch is 1, the algorithm will be BCO(0)
            batch_size=128,
            learning_rate=0.001,
            weight_decay=1e-4,
            decay_epoch=30,
        ...
        collect=dict(
            ...
            model_path=
            '/mnt/lustre/wanghaolin1/lisong/BCO/DI-engine/dizoo/mujoco/config/halfcheetah_sac/ckpt_best.pth.tar',
...
def train(args):
    ...
    main_config.policy.learn.train_epoch = args.train_epoch
    main_config.exp_name = 'halfcheetah_on_n100a2l3nde' + str(args.train_epoch) + '_e20nowd_p0_s0_v1'
    serial_pipeline_bco(
        [copy.deepcopy(main_config), copy.deepcopy(create_config)], [expert_main_config, expert_create_config],
        seed=0,
...
if __name__ == "__main__":
    ...
    parser.add_argument('--train_epoch', '-e', type=int, default=20)
